...
**🌐 Acesse a aplicação:** http://34.16.37.47:8000/
...
**📚 Base URL:** `http://34.16.37.47:8000/api/`

```
# Documentação
http://34.16.37.47:8000/swagger/
http://34.16.37.47:8000/redoc/

# API
http://34.16.37.47:8000/api/vagas/
http://34.16.37.47:8000/api/curriculos/
http://34.16.37.47:8000/api/ml/health/
```
...
```bash
# Listar vagas
curl http://34.16.37.47:8000/api/vagas/

# Predição para vaga específica
curl "http://34.16.37.47:8000/api/vagas/1/predict/?top_k=10"

# Status do sistema
curl http://34.16.37.47:8000/api/ml/health/
```
